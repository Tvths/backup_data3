...
hi_name <- function(namn){
  #Skapa 2 variabler hälsa och motivering som nedan. 
  hälsa <- "Hi" 
  motivering <- "Keep coding!"
  #Slå ihop alla variabler samtidigt lägga till mellanslag mellan värderna och tecken !.
  cat(paste0(hälsa,sep=" ", namn, sep = "! ", motivering))
}
